...
for model_name, model in models.items():
    ...
    joblib.dump(model, f'models/read_model_{model_name}.joblib')  # 使用joblib保存模型
...
# 自定义调色板
    ...
    # 保存图像
    plt.savefig(f'models/read-{model_name}.png', bbox_inches='tight')
...
plt.savefig('models/read_total.png', dpi=300, bbox_inches='tight')
